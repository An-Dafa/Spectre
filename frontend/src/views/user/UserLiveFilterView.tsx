          ...
          <div className="live-frame live-platform-frame">
            ...
            {activeSource === "backend" && backendStreamUrl && !mjpegError ? (
              ...
              <div className="empty-state live-empty-state">
                ...
                <span>Choose a camera pipeline and press Start Live to begin frame redaction.</span>
              </div>
            ) : (
              <div className="empty-state live-empty-state">
                <RefreshCw className="spin" size={34} />
                <strong>Preparing redaction frames</strong>
                <span>The camera is active and the backend is processing the first frame.</span>
              </div>
            )}
          </div>
