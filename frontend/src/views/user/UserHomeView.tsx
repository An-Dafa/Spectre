      ...
      <section className="user-section">
        ...
        <div className="tool-card-grid">
          <ToolCard
            ...
            description="Upload identity documents and let Spectre redact sensitive areas before sharing."
          ...
          <ToolCard
            ...
            description="Enable real-time privacy filtering for a live camera feed from the device."
